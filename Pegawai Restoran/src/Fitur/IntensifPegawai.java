...
public class IntensifPegawai {
    public static void main(String[] args) {
        ...
        String namaPegawai;
        int gajiAwal = 4000000, jumlahIzin, nominalIzin = 100000, gajiAkhir, izin, intensifPegawai = 100000, lembur,
        ...
        izin = jumlahIzin * nominalIzin;
        gajiLembur = lembur * intensifPegawai;
        gajiAkhir = gajiAwal - izin + gajiLembur;
        ...
        System.out.println("Potongan izin\t: " + izin);
